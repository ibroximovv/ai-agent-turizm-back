...
This document defines strict rules, conventions, and DDL schema specifications for PostgreSQL in the project. All database entities, tables, columns, constraints, and enums MUST be named in English using standard conventions.
...
CREATE TYPE material_type AS ENUM (
  'presentation',   -- taqdimot (slides / PPTX)
  'questions',      -- savollar (test/exam questions)
  'literature'      -- adabiyotlar (books, laws, articles)
);

CREATE TYPE material_status AS ENUM (
  'new',            -- newly uploaded, unprocessed
  'queued',         -- in queue for worker
  'converting',     -- text extraction and markdown formatting
  'md_ready',       -- markdown generated, ready for Open WebUI
  'uploading',      -- sending to Open WebUI knowledge base
  'indexed',        -- successfully indexed in knowledge base
...
CREATE TABLE materials (
  ...
  detected_script VARCHAR(30), -- 'latin', 'cyrillic_to_latin', 'russian'
